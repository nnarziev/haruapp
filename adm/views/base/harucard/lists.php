							...
							<table summary="<?php echo $CFX->title(); ?>" class="com_table row_table">
								...
								<?php for ($i=0; $i<count($view_data['list']['member_list']); $i++) { ?>
									<tr>
										...
										<td><span class="title"><?php echo $view_data['list']['member_list'][$i]['hc_current_part'] ?></span></td>
										...
										<td><span class="title"><?php echo $view_data['list']['member_list'][$i]['hc_activated'] ?></span></td>
										<td><span class="title"><?php echo $view_data['list']['member_list'][$i]['login_datetime'] ?></span></td>	
										<td><span class="title"><?php echo $view_data['list']['member_list'][$i]['hc_created_datetime'] ?></span></td>	
									</tr>
								<?php } // end for ?>
