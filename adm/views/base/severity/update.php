			...
			<section class="container">
				<div class="container_inner">
					<article>
						...
						<form name="severityUpdateForm" id="severityUpdateForm" method="post">
						...
						<table summary="심각도 평가 수정" class="com_table col_table">
							<colgroup>
								<col width="15%">
								<col width="35%">
								<col width="15%">
							...
							<tr>
								<th scope="col">분류명*</th>
								<td colspan="3">
									<?php echo $view_data['update']['severity_view']['severity_group']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['update']['severity_view']['severity_order']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="severity_title" type="text" value="<?php echo $view_data['update']['severity_view']['severity_title']; ?>" placeholder="" maxlength="255" class="cm_ip w100_ip">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="severity_name" type="text" value="<?php echo $view_data['update']['severity_view']['severity_name']; ?>" placeholder="" maxlength="255" class="cm_ip w100_ip">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="severity_text1" type="text" value="<?php echo $view_data['update']['severity_view']['severity_text1']; ?>" placeholder="" maxlength="255" class="cm_ip w300_ip">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="severity_text2" type="text" value="<?php echo $view_data['update']['severity_view']['severity_text2']; ?>" placeholder="" maxlength="255" class="cm_ip w300_ip">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="severity_text3" type="text" value="<?php echo $view_data['update']['severity_view']['severity_text3']; ?>" placeholder="" maxlength="255" class="cm_ip w300_ip">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="severity_text4" type="text" value="<?php echo $view_data['update']['severity_view']['severity_text4']; ?>" placeholder="" maxlength="255" class="cm_ip w300_ip">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="severity_text5" type="text" value="<?php echo $view_data['update']['severity_view']['severity_text5']; ?>" placeholder="" maxlength="255" class="cm_ip w300_ip">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<input name="severity_text6" type="text" value="<?php echo $view_data['update']['severity_view']['severity_text6']; ?>" placeholder="" maxlength="255" class="cm_ip w300_ip">
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['update']['severity_view']['severity_type']; ?>
								</td>
							</tr>
							...
							<tr>
								<th scope="col">수정일*</th>
								<td colspan="3">
									<?php echo $view_data['update']['severity_view']['modified_datetime']; ?>
								</td>
							</tr>
...
//<![CDATA[
	$(document).ready(function() {
		...
		$('#severityUpdateForm').validate({
			rules : {
				'severity_title' : {required : true}
		    },
		    messages : {
				'severity_title' : {
