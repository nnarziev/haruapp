					...
					<div class="container_inner">
						<article>
							...
							<table summary="<?php echo $CFX->title(); ?>" class="com_table row_table">
								...
								<tbody>
								<?php for ($i=0; $i<count($view_data['list']['survey_list']); $i++) { ?>
									<tr>
										<td><span class="title"><?php echo $view_data['list']['survey_list'][$i]['num'] ?></span></td>
										<td><span class="title"><?php echo $view_data['list']['survey_list'][$i]['survey_group'] ?></span></td>
										<td><span class="title"><?php echo $view_data['list']['survey_list'][$i]['survey_order'] ?></span></td>
										<td class="text_left"><span class="title"><a href="<?php echo $view_data['list']['survey_list'][$i]['view_href']; ?>"><?php echo $view_data['list']['survey_list'][$i]['survey_title']; ?></a></span></td>
										<td><span class="title"><?php echo $view_data['list']['survey_list'][$i]['survey_type'] ?></span></td>
										<td><span class="title"><?php echo $view_data['list']['survey_list'][$i]['modified_datetime'] ?></span></td>
									</tr>
								<?php } // end for ?>
								<?php if (count($view_data['list']['survey_list']) == 0) { ?>
									<tr>
							...
							<?php echo $view_data['list']['survey_pages']; ?>
