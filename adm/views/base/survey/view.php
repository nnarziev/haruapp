			...
			<section class="container">
				<div class="container_inner">
					<article>
						...
						<table summary="추가 설문  보기" class="com_table col_table">
							<colgroup>
								<col width="15%">
								<col width="35%">
								<col width="15%">
							...
							<tr>
								<th scope="col">분류명*</th>
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_group']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_order']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_title']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_name']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_text1']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_text2']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_text3']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_text4']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_text5']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_text6']; ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['survey_type']; ?>
								</td>
							</tr>
							...
							<tr>
								<th scope="col">수정일*</th>
								<td colspan="3">
									<?php echo $view_data['view']['survey_view']['modified_datetime']; ?>
								</td>
							</tr>
