					...
					<article>
						...
						<table summary="회원관리 수정" class="com_table col_table">
							...
							<tr>
								...
								<td colspan="3">
									<select id="group" name="group" class="cm_sl ca_sl">
							...
							<tr>
								<th scope="col">이름*</th>
								<td colspan="3">
									<input id="member_name" name="member_name" type="text" value="<?php echo $view_data['update']['member_view']['name']; ?>" placeholder="" maxlength="20" class="cm_ip w150_ip"> ( 프로젝트 관리자 명을 입력하세요. )
								</td>
							</tr>
