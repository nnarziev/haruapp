...
class Harucard_Controller extends CFX_Controller {
	...
	public function lists()
	{
		...
		$result = array();
		$result = $this->harucard_model->get_lists();	// 메소드 호출
	...
	public function view()
	{
		...
		$result = array();
		$result = $this->harucard_model->get_view();	// 메소드 호출
	...
	public function update()
	{
		...
		if ($_SERVER['REQUEST_METHOD'] === 'POST')
		{
			// 하루카드 업데이트 처리
			$this->load->model('harucard'); // 모델 로드			
			$result = $this->harucard_model->post_update();	// 메소드 호출

 			if ($result['menu'] == 'update_harucard_join_member')
			{
			...
			$result = array();
			$result = $this->harucard_model->get_update();	// 메소드 호출
