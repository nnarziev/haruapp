...
class Gift_Controller extends CFX_Controller {
	...
	public function lists()
	{
		...
		$this->load->model('gift'); // 모델 로드
		
		$result = array();
		$result = $this->gift_model->get_lists();	// 메소드 호출
	...
	public function view()
	{
		...
		$result = array();
		$result = $this->gift_model->get_view();	// 메소드 호출
	...
	public function update()
	{
		...
		if ($_SERVER['REQUEST_METHOD'] === 'POST')
		{
			...
			// 설문 스크리닝 업데이트 처리
			$this->load->model('gift'); // 모델 로드			
			$result = $this->gift_model->post_update();	// 메소드 호출

 			if ($result['menu'] == 'update_gift')
			{
			...
			$result = array();
			$result = $this->gift_model->get_update();	// 메소드 호출
